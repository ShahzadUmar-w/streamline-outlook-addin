...
const xifinProducts = [
  "AI Products",
  "Billing Services (formerly OSB)",
  "CareAlerts",
  "Empower LIS",
  "Empower RCM (formerly RPM)",
  "Encounter- Rx",
  "Fusion Rx",
  "Other XiFin not listed",
  "Pharmacy Essentials (formerly known as CareCLAIM)",
  "Pharmacy Essentials (as a component of Pharmacy Enterprise)",
  "Radiology (not on Empower RCM XiFin RPM)",
  "SaaS+ Services added to Empower RCM",
  "Strand",
];
...
export const requestForms: Record<
  RequestType,
  { description: string; fields: RequestFieldDefinition[] }
> = {
  "General Legal Request": {
    ...
    fields: [
      {
        ...
        options: [
          ...
          "Corporate",
          "Current Sales Contract Interpretation/ Question",
          "Current Vendor Contract Interpretation/ Question",
          "Cybersecurity Questions (Non-Questionnaires)",
          "Development & Product",
          "EDI",
          "Facilities/ Leases",
          "HR",
          ...
          "Other Legal Matter",
          "Pre-Sales & Post- Sales Questionnaires",
          "Pre-Sales Questions",
    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          "Marketing",
          "Mergers & Acquisitions",
          "Other vendor contract not listed here",
          "Technical Services",
        ],
      },
      {
  ...
  "Business Development Request": {
    ...
    fields: [
      ...
      },
      {
        ...
        required: true,
        options: [
          "Integration with XiFin products/ services",
          "Referral of opportunities",
          "Distribution/ Sale",
          "Development",
          "Co-Marketing",
      ...
      },
      {
        ...
        options: xifinProducts,
        conditional: (v: any) =>
          v.relType?.includes("Integration with XiFin products/ services"),
      },
      {
      ...
      },
      {
        ...
        type: "select",
        conditional: (v: any) =>
          v.relType?.includes("Distribution/ Sale") ||
          v.relType?.includes("White Label product distribution"),
